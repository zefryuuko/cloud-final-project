...
export default function Chat(args){
    const formatify = (text) => {
        ...
        newText = newText.replace(url, url => {
            ...
            if (url.match(/\.(jpeg|jpg|gif|png)/) != null) return '<img src=' + realurl + ' loading="lazy">';
    ...
    <div className={args.recent ? 'me recent' : 'me'} id={args.top && 'newTop'}>
    ...
    : args.sender === 'other' ? 
    <div className={args.recent ? 'other recent' : 'other'} id={args.top && 'newTop'}>
